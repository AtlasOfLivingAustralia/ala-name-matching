...
public class ALANameSearcherTest {
    ...
    public void testInfragenricAndSoundEx6() {
        ...
        try {
            ...
            assertEquals("https://biodiversity.org.au/afd/taxa/cd651aef-f210-45b1-8652-3a33581d1beb", nsr.getAcceptedLsid());
            assertEquals(MatchType.SOUNDEX, nsr.getMatchType());
        } catch (SearchResultException ex) {
            fail("Unexpected search exception " + ex.getMessage());
        }
    ...
    public void testSearchForLSID1() {
        try {
            ...
            assertEquals("https://biodiversity.org.au/afd/taxa/1ec0e393-64a1-4df4-aacb-44c605b605b8", lsid);
        } catch (SearchResultException ex) {
            fail("Unexpected search exception " + ex.getMessage());
        }
    }
...
// Appears to have been corrected in AFD - no need for this test
//    @Test

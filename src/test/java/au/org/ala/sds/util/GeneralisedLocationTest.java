...
public class GeneralisedLocationTest {
    ...
    public void TestLocationGeneralisation() {
        GeneralisedLocation extremeGeneralisation = new GeneralisedLocation(LAT, LONG, SensitivityCategory.CRITICALLY_ENDANGERED);
        ...
        GeneralisedLocation highGeneralisation = new GeneralisedLocation(LAT, LONG, SensitivityCategory.ENDANGERED);
        ...
        GeneralisedLocation mediumGeneralisation = new GeneralisedLocation(LAT, LONG, SensitivityCategory.VULNERABLE);
        ...
        GeneralisedLocation lowGeneralisation = new GeneralisedLocation(LAT, LONG, SensitivityCategory.NEAR_THREATENED);
        ...
        GeneralisedLocation defaultGeneralisation = new GeneralisedLocation(LAT, LONG, SensitivityCategory.LEAST_CONCERN);

        ...
        <ul class="webserviceList">
            ...
            <li><a href="#downloadFromDB"><strong>Occurrence download:</strong></a> /occurrences/download - needs request param definition<br>
                ...
                <ul class="paramList">
                    ...
                    <li><strong>qa</strong> - A CSV list of record issues to include in the download. See <a href="${webservicesRoot}/occurrences/search?q=*:*&facets=assertions&pageSize=0">assertions</a> for possible values to include.  By default it will include all applicable issues. To include no issue supply none as the value (eg &qa=none) 
                </ul>
                <p>

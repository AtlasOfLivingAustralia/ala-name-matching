      ...
      <json:array name="Result" var="geoRegionDataResource" items="${geoRegionDataResources}">
        <json:object>
          ...
          <json:property name="occurrencesUrl">
              ${pageContext.request.contextPath}/occurrences/searchWithTable.htm?<gbif:criterion subject="24" predicate="0" value="${geoRegionDataResource.dataResourceId}" index="0"/>&<gbif:criterion subject="36" predicate="0" value="${geoRegion.id}" index="1"/>
          </json:property>
          ...
          <json:property name="georeferencedOccurrencesUrl">
              ${pageContext.request.contextPath}/occurrences/searchWithTable.htm?<gbif:criterion subject="24" predicate="0" value="${geoRegionDataResource.dataResourceId}" index="0"/>&<gbif:criterion subject="36" predicate="0" value="${geoRegion.id}" index="1"/>&<gbif:criterion subject="28" predicate="0" value="0" index="2"/>
          </json:property>

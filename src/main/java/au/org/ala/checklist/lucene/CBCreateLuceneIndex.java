...
//        LineIterator lines = new LineIterator(new BufferedReader(new InputStreamReader(this.getClass().getClassLoader().getResource("au/org/ala/propertystore/known_homonyms.txt").openStream())));
//       // Set<String> knownHomonyms = new HashSet<String>();
...
//        System.out.println("creating index " + name + " " + classification + " " + id + " " + lsid + " " + rank + " " + rankString+ " " + kingdom + " " + genus);
    ...
    public static void main(String[] args)throws Exception{
        ...
        if(args.length == 2){
            ...
            System.out.println("au.org.ala.checklist.lucene.CBCreateLuceneIndex <cb-names export file> <index directory>");

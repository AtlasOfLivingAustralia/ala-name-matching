...
public class AssertionController extends AbstractSecureController {
    ...
    @RequestMapping(value = {"/assertions/query/{uuid}", "/assertions/query/{uuid}/"}, method = RequestMethod.GET)
    ...
    @RequestMapping(value = {"/assertions/queries/{uuids}", "/assertions/queries/{uuids}/"}, method = RequestMethod.GET)
    ...
    @RequestMapping(value = {"/assertions/query/{uuid}/apply", "/assertions/query/{uuid}/apply/"}, method = RequestMethod.GET)

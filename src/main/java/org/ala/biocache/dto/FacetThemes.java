...
public class FacetThemes {
    ...
    static {
        ...
        allThemes.add(new FacetTheme("Geospatial","uncertainty","sensitive","state_conservation","raw_state_conservation","places","state","country","biogeographic_region","ibra","imcra","cl918","cl617","cl620","geospatial_kosher"));

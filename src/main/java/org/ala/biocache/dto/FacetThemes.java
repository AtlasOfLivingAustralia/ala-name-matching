...
public class FacetThemes {
    ...
    static {
        allThemes.add(new FacetTheme("Taxonomic", "taxon_name", "raw_taxon_name", "subspecies_name", "species_guid", "genus_guid","family","order","class", "phylum", "kingdom","species_group","rank","interaction","species_habitats"));
        allThemes.add(new FacetTheme("Geospatial","uncertainty","sensitive","state_conservation","raw_state_conservation","cl959","state","country","biogeographic_region","ibra","imcra","cl966","cl918","cl617","cl620","geospatial_kosher"));
        ...
        allThemes.add(new FacetTheme("Record Assertions", "assertions", "outlier_layer", "outlier_layer_count","taxonomic_issue"));

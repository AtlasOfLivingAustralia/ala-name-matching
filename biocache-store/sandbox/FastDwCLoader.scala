//The new Casandra API does not have "ThriftGlue"
//TODO work out how to perform this task using the new API
...
//        StorageService.instance.forceTableCompaction("occ","occ")

...
public enum MatchType{
        ...
        PHRASE("phraseMatch", "A match was deermined by parsing the name into a phrase name.  Very small chance of an incorrect match."),
        SOUNDEX("fuzzyMatch", "A match was determined by using a sound expression of the supplied name.  There is a greater that aveage chance that the match is incorrect."),

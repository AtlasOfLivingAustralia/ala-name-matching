...
public class MatchTaxonConditionTest extends TestUtils {
    ...
    public void testMatch6() {
        MatchTaxonCondition condition = new MatchTaxonCondition();
        condition.setNomenclaturalStatus(NomenclaturalStatus.DOUBTFUL);
        TaxonConceptInstance instance = new TaxonConceptInstance("ID-1", NomenclaturalClassifier.BOTANICAL, NomenclaturalClassifier.BOTANICAL.getAcronym(), this.provider, "Acacia dealbata", null, null, null, TaxonomicType.ACCEPTED, TaxonomicType.ACCEPTED.getTerm(), RankType.SPECIES, RankType.SPECIES.getRank(),null, null,null, null, null, null, null, null, null, null, null, null);
        NameKey key = this.analyser.analyse(instance).getNameKey();
        assertFalse(condition.match(instance, key));
    }
    ...
    public void testMatch7() {
        MatchTaxonCondition condition = new MatchTaxonCondition();
        condition.setNomenclaturalStatus(NomenclaturalStatus.DOUBTFUL);
        TaxonConceptInstance instance = new TaxonConceptInstance("ID-1", NomenclaturalClassifier.BOTANICAL, NomenclaturalClassifier.BOTANICAL.getAcronym(), this.provider, "Acacia dealbata", null, null, null, TaxonomicType.ACCEPTED, TaxonomicType.ACCEPTED.getTerm(), RankType.SPECIES, RankType.SPECIES.getRank(), Collections.singleton(NomenclaturalStatus.ALTERNATIVE), "alternative", null, null, null, null, null, null, null, null, null, null);
        NameKey key = this.analyser.analyse(instance).getNameKey();
        assertFalse(condition.match(instance, key));
    }
    ...
    public void testMatch9() {
        MatchTaxonCondition condition = new MatchTaxonCondition();
        condition.setNameType(NameType.SCIENTIFIC);
        TaxonConceptInstance instance = new TaxonConceptInstance("ID-1", NomenclaturalClassifier.BOTANICAL, NomenclaturalClassifier.BOTANICAL.getAcronym(), this.provider, "Acacia unplaced", null, null,null, TaxonomicType.ACCEPTED, TaxonomicType.ACCEPTED.getTerm(), RankType.SPECIES, RankType.SPECIES.getRank(), null, null, null, null, null, null, null, null, null, null, null, null);
        NameKey key = this.analyser.analyse(instance).getNameKey();
        assertFalse(condition.match(instance, key));
    }
    ...
    public void testMatch12() {
        ...
        TaxonConceptInstance instance = new TaxonConceptInstance("ID-1", NomenclaturalClassifier.BOTANICAL, NomenclaturalClassifier.BOTANICAL.getAcronym(), this.provider, "Acacia dealbata", null, null, "1974", TaxonomicType.ACCEPTED, TaxonomicType.ACCEPTED.getTerm(), RankType.SPECIES, RankType.SPECIES.getRank(), null, null, null, null, null, null, null, null, null, null, null, null);
        NameKey key = this.analyser.analyse(instance).getNameKey();
        assertTrue(condition.match(instance, key));
    }
    ...
    public void testMatch13() {
        MatchTaxonCondition condition = new MatchTaxonCondition();
        condition.setYear("1974");
        TaxonConceptInstance instance = new TaxonConceptInstance("ID-1", NomenclaturalClassifier.BOTANICAL, NomenclaturalClassifier.BOTANICAL.getAcronym(), this.provider, "Acacia dealbata", null, null, "1975", TaxonomicType.ACCEPTED, TaxonomicType.ACCEPTED.getTerm(), RankType.SPECIES, RankType.SPECIES.getRank(), null, null, null, null, null, null, null, null, null, null, null, null);
        NameKey key = this.analyser.analyse(instance).getNameKey();
        assertFalse(condition.match(instance, key));
    }
    ...
    public void testMatch21() {
        ...
        TaxonConceptInstance instance = new TaxonConceptInstance("ID-1", NomenclaturalClassifier.BOTANICAL, NomenclaturalClassifier.BOTANICAL.getAcronym(), this.provider, "Mycofalcela calcarata", null, null, "1975", TaxonomicType.ACCEPTED, TaxonomicType.ACCEPTED.getTerm(), RankType.SPECIES, RankType.SPECIES.getRank(), null, null, null, null, null, null, null, null, null, null, null, null);
        NameKey key = this.analyser.analyse(instance).getNameKey();
        assertTrue(condition.match(instance, key));
    }
    ...
    public void testMatch22() {
        ...
        condition.setMatchType(NameMatchType.NORMALISED);
        TaxonConceptInstance instance = new TaxonConceptInstance("ID-1", NomenclaturalClassifier.BOTANICAL, NomenclaturalClassifier.BOTANICAL.getAcronym(), this.provider, "Aphanesia grei", null, null, "1975", TaxonomicType.ACCEPTED, TaxonomicType.ACCEPTED.getTerm(), RankType.SPECIES, RankType.SPECIES.getRank(), null, null, null, null, null, null, null, null, null, null, null, null);
        NameKey key = this.analyser.analyse(instance).getNameKey();
        assertTrue(condition.match(instance, key));
    }
    ...
    public void testMatch23() {
        ...
        condition.setScientificName("Aphanesia greyi");
        condition.setMatchType(NameMatchType.NORMALISED);
        TaxonConceptInstance instance = new TaxonConceptInstance("ID-1", NomenclaturalClassifier.BOTANICAL, NomenclaturalClassifier.BOTANICAL.getAcronym(), this.provider, " Aphanesia  greyi  ", null, null, "1975", TaxonomicType.ACCEPTED, TaxonomicType.ACCEPTED.getTerm(), RankType.SPECIES, RankType.SPECIES.getRank(), null, null, null, null, null, null, null, null, null, null, null, null);
        NameKey key = this.analyser.analyse(instance).getNameKey();
        assertTrue(condition.match(instance, key));
    }
    ...
    public void testMatch25() {
        ...
        TaxonConceptInstance instance1 = new TaxonConceptInstance("ID-1", NomenclaturalClassifier.BOTANICAL, NomenclaturalClassifier.BOTANICAL.getAcronym(), this.provider, "Mycofalcella calcarata", null, null, "1975", TaxonomicType.ACCEPTED, TaxonomicType.ACCEPTED.getTerm(), RankType.SPECIES, RankType.SPECIES.getRank(), null, null, null, null, null, null, null, null, null, null, null, null);
        NameKey key1 = this.analyser.analyse(instance1).getNameKey();
        assertTrue(condition.match(instance1, key1));
        TaxonConceptInstance instance2 = new TaxonConceptInstance("ID-1", NomenclaturalClassifier.BOTANICAL, NomenclaturalClassifier.BOTANICAL.getAcronym(), this.provider, "Mycofalcela calcrata", null, null, "1975", TaxonomicType.ACCEPTED, TaxonomicType.ACCEPTED.getTerm(), RankType.SPECIES, RankType.SPECIES.getRank(), null, null, null, null, null, null, null, null, null, null, null, null);
    ...
    public void testMatch28() {
        ...
        TaxonConceptInstance instance = new TaxonConceptInstance("ID-1", NomenclaturalClassifier.BOTANICAL, NomenclaturalClassifier.BOTANICAL.getAcronym(), this.provider, "Lepidosperma leptophyllum", "Benth.", null, "1975", TaxonomicType.ACCEPTED, TaxonomicType.ACCEPTED.getTerm(), RankType.SPECIES, RankType.SPECIES.getRank(), null, null, null, null, null, null, null, null, null, null, null, null);
        NameKey key = this.analyser.analyse(instance).getNameKey();
        assertTrue(condition.match(instance, key));
    }
    ...
    public void testMatch30() {
        ...
        condition.setScientificNameAuthorship("Benth.");
        condition.setMatchType(NameMatchType.EXACT);
        TaxonConceptInstance instance = new TaxonConceptInstance("ID-1", NomenclaturalClassifier.BOTANICAL, NomenclaturalClassifier.BOTANICAL.getAcronym(), this.provider, "Lepidosperma leptophyllum", "Bentham", null, "1975", TaxonomicType.ACCEPTED, TaxonomicType.ACCEPTED.getTerm(), RankType.SPECIES, RankType.SPECIES.getRank(), null, null, null, null, null, null, null, null, null, null, null, null);
        NameKey key = this.analyser.analyse(instance).getNameKey();
        assertFalse(condition.match(instance, key));
    }
    ...
    public void testMatch36() {
        ...
        condition.setScientificNameAuthorship("Benth.");
        condition.setMatchType(NameMatchType.NORMALISED);
        TaxonConceptInstance instance = new TaxonConceptInstance("ID-1", NomenclaturalClassifier.BOTANICAL, NomenclaturalClassifier.BOTANICAL.getAcronym(), this.provider, "Lepidosperma leptophyllum", "L.", null, "1975", TaxonomicType.ACCEPTED, TaxonomicType.ACCEPTED.getTerm(), RankType.SPECIES, RankType.SPECIES.getRank(), null, null, null, null, null, null, null, null, null, null, null, null);
        NameKey key = this.analyser.analyse(instance).getNameKey();
        assertFalse(condition.match(instance, key));
    }
    ...
    public void testMatch39() {
        ...
        condition.setScientificNameAuthorship("[Bb]enth(am|\\.)?");
        condition.setMatchType(NameMatchType.REGEX);
        TaxonConceptInstance instance = new TaxonConceptInstance("ID-1", NomenclaturalClassifier.BOTANICAL, NomenclaturalClassifier.BOTANICAL.getAcronym(), this.provider, "Lepidosperma leptophyllum", "Benthos", null, "1975", TaxonomicType.ACCEPTED, TaxonomicType.ACCEPTED.getTerm(), RankType.SPECIES, RankType.SPECIES.getRank(), null, null, null, null, null, null, null, null, null, null, null, null);
        NameKey key = this.analyser.analyse(instance).getNameKey();
        assertFalse(condition.match(instance, key));
    }
    ...
    public void testMatch42() {
        ...
        condition.setMatchType(NameMatchType.REGEX);
        TaxonConceptInstance instance = new TaxonConceptInstance("ID-1", NomenclaturalClassifier.BOTANICAL, NomenclaturalClassifier.BOTANICAL.getAcronym(), this.provider, "unknown", null, null, "1975", TaxonomicType.ACCEPTED, TaxonomicType.ACCEPTED.getTerm(), RankType.SPECIES, RankType.SPECIES.getRank(), null, null, null, null, null, null, null, null, null, null, null, null);
        NameKey key = this.analyser.analyse(instance).getNameKey();
        assertTrue(condition.match(instance, key));
        instance = new TaxonConceptInstance("ID-1", NomenclaturalClassifier.BOTANICAL, NomenclaturalClassifier.BOTANICAL.getAcronym(), this.provider, "Unknown sp.", null, null, "1975", TaxonomicType.ACCEPTED, TaxonomicType.ACCEPTED.getTerm(), RankType.SPECIES, RankType.SPECIES.getRank(), null, null, null, null, null, null, null, null, null, null, null, null);
        key = this.analyser.analyse(instance).getNameKey();
        assertTrue(condition.match(instance, key));
        instance = new TaxonConceptInstance("ID-1", NomenclaturalClassifier.BOTANICAL, NomenclaturalClassifier.BOTANICAL.getAcronym(), this.provider, "Unknownsp.", null, null, "1975", TaxonomicType.ACCEPTED, TaxonomicType.ACCEPTED.getTerm(), RankType.SPECIES, RankType.SPECIES.getRank(), null, null, null, null, null, null, null, null, null, null, null, null);
        key = this.analyser.analyse(instance).getNameKey();
        assertFalse(condition.match(instance, key));
    }
    ...
    public void testMatch43() {
        ...
        NameKey key = this.analyser.analyse(instance).getNameKey();
        assertFalse(condition.match(instance, key));
        instance = new TaxonConceptInstance("ID-1", NomenclaturalClassifier.BOTANICAL, NomenclaturalClassifier.BOTANICAL.getAcronym(), this.provider, "Unknown sp.", null, null, "1975", TaxonomicType.ACCEPTED, TaxonomicType.ACCEPTED.getTerm(), RankType.SPECIES, RankType.SPECIES.getRank(), null, null, null, null, null, null, null, null, null, null, Collections.singleton(TaxonFlag.AUTONYM), null);
        key = this.analyser.analyse(instance).getNameKey();
        assertFalse(condition.match(instance, key));
    ...
    public void testRead1() throws Exception {
        ...
        TaxonConceptInstance instance = new TaxonConceptInstance("ID-1", NomenclaturalClassifier.BOTANICAL, NomenclaturalClassifier.BOTANICAL.getAcronym(), this.provider, "Acacia dealbata", null, null, "1975", TaxonomicType.EXCLUDED, TaxonomicType.EXCLUDED.getTerm(), RankType.SPECIES, RankType.SPECIES.getRank(), null, null, null, null, null, null, null, null, null, null, null, null);
        NameKey key = this.analyser.analyse(instance).getNameKey();
        assertTrue(condition.match(instance, key));
        instance = new TaxonConceptInstance("ID-1", NomenclaturalClassifier.BOTANICAL, NomenclaturalClassifier.BOTANICAL.getAcronym(), this.provider, "Acacia dealbata", null, null, "1975", TaxonomicType.ACCEPTED, TaxonomicType.ACCEPTED.getTerm(), RankType.SPECIES, RankType.SPECIES.getRank(), null, null, null, null, null, null, null, null, null, null, null, null);
        key = this.analyser.analyse(instance).getNameKey();
